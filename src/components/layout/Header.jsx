        ...
        <header className="h-14 sm:h-16 flex items-center justify-between px-3 sm:px-4 md:px-6 bg-[#e8e8e6]">
            ...
            <div className="flex-1 max-w-xs sm:max-w-md lg:max-w-lg">
                <div className={`relative group transition-all duration-300 ${isSearchFocused ? 'scale-[1.02]' : ''}`}>
                    ...
                    <input
                        type="text"
                        className="block w-full pl-9 sm:pl-10 pr-3 py-2 sm:py-2.5 border-none rounded-full leading-5 
                                 bg-white text-gray-900 placeholder-gray-400
                                 focus:outline-none focus:ring-2 focus:ring-primary/30 
                                 text-xs sm:text-sm shadow-sm hover:shadow-md transition-all duration-200"
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 ml-2 sm:ml-4">
                ...
                <div className="flex items-center bg-white rounded-full p-1 shadow-sm hover:shadow-md transition-all duration-200 space-x-1">
                    <button
                        className="p-1.5 sm:p-2 rounded-full text-gray-500 lg:hidden
                                 hover:bg-gray-100 active:bg-gray-200 active:scale-90 transition-all duration-200"
                        onClick={onMenuClick}
                    >
                        <Menu size={16} />
                    </button>
                ...
                <button className="flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 bg-primary text-white rounded-full shadow 
