        ...
        <div className="flex flex-col space-y-3 sm:space-y-4 mb-4 sm:mb-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div className="flex items-center -space-x-2 overflow-x-auto pb-1 sm:pb-0 relative z-10">
                    <button className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center
                    ...
                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-black flex items-center justify-center text-white text-xs font-bold ring-2 ring-white ml-2 
                                  hover:ring-gray-200 hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer flex-shrink-0">
                        C
                    </div>
                </div>
                ...
                <div className="flex items-center space-x-2 sm:space-x-3 bg-white px-2 sm:px-3 py-1.5 rounded-full shadow-sm hover:shadow-md transition-all duration-200 self-start sm:self-auto relative" ref={datePickerRef}>
                    ...
                    <div className="flex items-center text-xs sm:text-sm font-medium text-gray-600 cursor-pointer hover:text-gray-900 transition-colors duration-200"
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex space-x-2 pt-2">
                                    <button onClick={() => setShowDatePicker(false)}
                                        className="flex-1 px-3 py-2 text-xs font-medium text-gray-600 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">Cancel</button>
                                    <button onClick={() => setShowDatePicker(false)}
                                        className="flex-1 px-3 py-2 text-xs font-medium text-white bg-primary rounded-lg hover:bg-red-600 transition-colors">Apply</button>
                                </div>
                            </div>
                        </div>
                    )}
...
const Avatar = ({ name, src }) => (
    <div className="relative flex items-center pl-1 pr-2 sm:pr-3 py-1 bg-white rounded-full border border-gray-100 shadow-sm ml-2 first:ml-0 
                   hover:shadow-md hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer flex-shrink-0">
